...
def compileOneTime(studentID ) :
	...
	try: #compile OK
		...
		#run it 
		child = subprocess.Popen("docker run --rm -it --ulimit cpu=1 -v /home/cycuigopher/桌面/docker_gcc/:/usr/src/myapp gcc-test:v1 ./a > result.txt",shell=True)
		child.wait()
		print("execute OK")
		...
		#delete dir
		subprocess.check_output("rm -r /cal/"+studentID , shell=True ) #forceddd
